...
type OP_ID = ECHO.OPERATION_ID.BALANCE_FREEZE;

export default class BalanceFreezeOperation extends AbstractOperation<OP_ID> {
	id = ECHO.OPERATION_ID.BALANCE_FREEZE;
