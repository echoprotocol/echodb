...
type OP_ID = ECHO.OPERATION_ID.SIDECHAIN_BTC_BLOCK_PROCESS;

export default class SidechainBtcBlockProcessOperation extends AbstractOperation<OP_ID> {
	id = ECHO.OPERATION_ID.SIDECHAIN_BTC_BLOCK_PROCESS;
