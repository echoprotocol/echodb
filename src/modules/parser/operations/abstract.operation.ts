...
export default abstract class AbstractOperation<T extends ECHO.OPERATION_ID>{
	...
	public modifyBody<Y extends ECHO.KNOWN_OPERATION>(
		...
		_dBlock: TDoc<IBlock>,
	): Y extends ECHO.KNOWN_OPERATION ? ECHO.OPERATION_PROPS<Y> : unknown |
	Y extends ECHO.KNOWN_OPERATION ? Promise<ECHO.OPERATION_PROPS<Y>> : unknown { return operation.body; }
