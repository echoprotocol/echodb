...
export const FEE_PAYER_FIELD: { [x in ECHO.OPERATION_ID]: string} = {
	...
	[ECHO.OPERATION_ID.SIDECHAIN_ETH_SPV_CREATE]: 'committee_member_id',
	[ECHO.OPERATION_ID.SIDECHAIN_ETH_SPV_ADD_MISSED_TX_RECEIPT]: 'reporter',
	...
	[ECHO.OPERATION_ID.SIDECHAIN_ERC20_REGISTER_CONTRACT_OPERATION]: '',
	...
	[ECHO.OPERATION_ID.SIDECHAIN_ERC20_TRANSFER_ASSET]: 'account',
	...
	[ECHO.OPERATION_ID.SIDECHAIN_BTC_SPV_CREATE]: 'committee_member_id',
	[ECHO.OPERATION_ID.SIDECHAIN_BTC_SPV_ADD_MISSED_TX_RECEIPT]: 'reporter',
	[ECHO.OPERATION_ID.SIDECHAIN_SPV_EXCHANGE_EXCESS_FUNDS]: 'account',
	[ECHO.OPERATION_ID.SIDECHAIN_STAKE_ETH_UPDATE]: '',
	[ECHO.OPERATION_ID.SIDECHAIN_BTC_CREATE_STAKE_SCRIPT]: 'account',
	[ECHO.OPERATION_ID.SIDECHAIN_STAKE_BTC_UPDATE]: 'committee_member_id',
