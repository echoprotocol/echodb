...
export const FEE_PAYER_FIELD: { [x in ECHO.OPERATION_ID]: string} = {
	...
	[ECHO.OPERATION_ID.WITNESS_CREATE]: 'witness_account',
	[ECHO.OPERATION_ID.WITNESS_UPDATE]: 'witness_account',
	...
	[ECHO.OPERATION_ID.WORKER_CREATE]: 'owner',
	...
	[ECHO.OPERATION_ID.TRANSFER_TO_BLIND]: 'from',
	[ECHO.OPERATION_ID.BLIND_TRANSFER]: '', // stealth_transfer/_blind_transfer_operation/
	[ECHO.OPERATION_ID.TRANSFER_FROM_BLIND]: 'to',
	[ECHO.OPERATION_ID.ASSET_SETTLE_CANCEL]: 'account',
	[ECHO.OPERATION_ID.ASSET_CLAIM_FEES]: 'issuer',
	[ECHO.OPERATION_ID.FBA_DISTRIBUTE]: 'account_id',
